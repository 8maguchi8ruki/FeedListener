...
def create_all_site():
    ...
    c.execute('INSERT INTO all_site(sitename) VALUES("Yahoo!【 地域 】")')
    c.execute('INSERT INTO all_site(sitename) VALUES("産経新聞【 速報 】")')
    ...
    c.execute('INSERT INTO all_site(sitename) VALUES("産経新聞【 イベント 】")')
    ...
    c.execute('INSERT INTO all_site(sitename) VALUES("GIZMODO【 ライフスタイル 】")')
    c.execute('INSERT INTO all_site(sitename) VALUES("GIZMODO【 デザイン 】")')
    c.execute('INSERT INTO all_site(sitename) VALUES("GIZMODO【 ビジネス 】")')
    c.execute('INSERT INTO all_site(sitename) VALUES("GIZMODO【 ニュース 】")')
    conn.commit()
    c.close()
    conn.close()
