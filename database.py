...
def create_all_site():
    ...
    c.execute('INSERT INTO all_site(sitename) VALUES("Cnet")' )
    c.execute('INSERT INTO all_site(sitename) VALUES("GIZMODO")')
    c.execute('INSERT INTO all_site(sitename) VALUES("TechCrunch")' )
    c.execute('INSERT INTO all_site(sitename) VALUES("CoinPost")')
    c.execute('INSERT INTO all_site(sitename) VALUES("GIGAZINE")' )
    c.execute('INSERT INTO all_site(sitename) VALUES("VAIENCE")')
    c.execute('INSERT INTO all_site(sitename) VALUES("ITmedia")' )
    c.execute('INSERT INTO all_site(sitename) VALUES("CNN")')
    c.execute('INSERT INTO all_site(sitename) VALUES("NHK")' )
    c.execute('INSERT INTO all_site(sitename) VALUES("Yahoo!")')
    c.execute('INSERT INTO all_site(sitename) VALUES("産経新聞")' )
    c.execute('INSERT INTO all_site(sitename) VALUES("朝日新聞")')
    conn.commit()
    c.close()
    conn.close()
